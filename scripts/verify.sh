...
# 3. scripts
step "python scripts compile" "$PY -m py_compile scripts/seo-db.py scripts/wp-draft.py scripts/keyword-gate.py scripts/setup-status.py scripts/figures-png.py"
